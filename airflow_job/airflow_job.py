...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-guru")
    bq_project = Variable.get("bq_project", default_var="tough-shelter-473408-c0")
    ...
    batch_details = {
        ...
        "runtime_config": {
            "version": "2.2",  # Specify the  Dataproc version (if needed)
        },
        "environment_config": {
            "execution_config": {  
                "service_account": "374976406845-compute@developer.gserviceaccount.com",
                "network_uri": "projects/tough-shelter-473408-c0/global/networks/default",
                "subnetwork_uri": "projects/tough-shelter-473408-c0/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="tough-shelter-473408-c0",
        region="us-central1",
